...
# tmstamp=`date +%s`
# filename=transcribe_to_json
# zip -r "${filename}_${today}_${tmstamp}.zip" . -x build.sh updatelayer.sh test.js "node_modules/*" "build/*" "lambda-layer/*"
# mkdir ./build
# mv "${filename}_${today}_${tmstamp}.zip" ./build/